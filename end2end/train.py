...
#             model.parallelize(device_map)
    ...
    if model_args.hyper_param_search:
        ...
        def compute_metrics(eval_preds):
            ...
            ##
            ## error due to unknown -100 predicted token https://github.com/huggingface/transformers/issues/22634#issuecomment-1500429811 
    ...
    if training_args.do_predict:
        ...
        if trainer.is_world_process_zero():
            ...
            if training_args.predict_with_generate:
                ##
                ## error due to unknown -100 predicted token https://github.com/huggingface/transformers/issues/22634#issuecomment-1500429811 
                replaced_preds= np.where(test_results.predictions != -100, test_results.predictions, tokenizer.pad_token_id)
                ##
                ...
                test_preds = tokenizer.batch_decode(
                    replaced_preds, skip_special_tokens=True, clean_up_tokenization_spaces=True
                )
